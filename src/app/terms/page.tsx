    ...
    <div className='min-h-screen bg-[#fbfbfd] font-sans text-[15px] leading-[1.75] text-[#1a1a2e] antialiased'>
      <div className='mx-auto max-w-[720px] px-4 pt-10 pb-16 sm:px-6 sm:pt-14 sm:pb-24'>
        <header className='mb-10 border-b-[3px] border-[#3a6fd8] pb-7'>
          ...
          <h1 className='text-[22px] font-bold tracking-[-0.02em] sm:text-[26px]'>이용약관</h1>
          <p className='mt-2.5 text-[13px] text-[#55556e]'>시행일: 2026년 7월 __일 &nbsp;·&nbsp; 버전 1.0</p>
        </header>

        <section>
          <h2 className='mb-3 text-[17px] font-bold tracking-[-0.01em]'>제1조 (목적)</h2>
          <p className='mb-3'>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            <li className='mb-2'>
              &quot;서비스&quot;란 팀이 제공하는 Doda 애플리케이션 내의 AI 대국, 학습 스테이지, 복기(리뷰) 기능 등
              일체의 기능을 말합니다.
            </li>
            <li className='mb-2'>&quot;이용자&quot;란 본 약관에 동의하고 서비스를 이용하는 자를 말합니다.</li>
            <li className='mb-2'>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            <li className='mb-2'>본 약관은 서비스 화면 또는 연결 페이지에 게시함으로써 효력이 발생합니다.</li>
            <li className='mb-2'>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            <li className='mb-2'>
              서비스는 만 14세 이상인 자가 이용할 수 있습니다. 만 14세 미만인 자는 서비스를 이용할 수 없습니다.
            </li>
            <li className='mb-2'>
              이용자는 본인의 플랫폼 계정으로만 서비스에 로그인해야 하며, 타인의 계정을 도용해서는 안 됩니다.
            </li>
          </ol>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            <li className='mb-2'>
              이용자의 게임 진행 데이터(스테이지 진행, 대국 기록 등)는 이용자의 계정 또는 기기에 저장됩니다.
            </li>
            <li className='mb-2'>
          ...
          <ul className='my-1.5 mb-2.5 list-disc pl-5'>
            <li className='mb-1'>
              서비스의 소스코드, AI 엔진, 데이터를 역설계(리버스 엔지니어링), 디컴파일, 크롤링하는 행위
            </li>
            <li className='mb-1'>비정상적인 방법(매크로, 조작된 클라이언트 등)으로 서비스를 이용하는 행위</li>
            <li className='mb-1'>
              서비스의 콘텐츠(캐릭터, 이미지, 텍스트, 학습 커리큘럼 등)를 팀의 사전 동의 없이 복제, 배포, 상업적으로
              이용하는 행위
            </li>
            <li className='mb-1'>서버에 과도한 부하를 유발하거나 서비스 운영을 방해하는 행위</li>
            <li className='mb-1'>기타 관련 법령에 위반되는 행위</li>
          </ul>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            ...
            <li className='mb-2'>
              이용자가 서비스 내에서 생성한 대국 기보를 개인적·비상업적 용도로 활용하는 것은 제한하지 않습니다.
            </li>
          </ol>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            ...
            <li className='mb-2'>
              계정 삭제 시 게임 진행 데이터는 복구할 수 없으며, 개인정보의 파기는 개인정보처리방침에 따릅니다.
            </li>
            <li className='mb-2'>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            ...
            <li className='mb-2'>
              팀이 서비스 전체를 종료하는 경우 종료일 30일 전까지 앱 내 공지 또는 스토어 페이지를 통해 알립니다.
            </li>
          </ol>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            ...
            <li className='mb-2'>
              팀은 이용자의 기기 환경, 네트워크 상태로 인해 발생한 문제에 대해 책임을 지지 않습니다.
            </li>
          </ol>
          ...
          <ol className='mb-3 list-decimal pl-[22px]'>
            <li className='mb-2'>본 약관은 대한민국 법률에 따라 해석되고 적용됩니다.</li>
            <li className='mb-2'>
